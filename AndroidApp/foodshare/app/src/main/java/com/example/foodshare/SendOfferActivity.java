...
import com.example.foodshare.models.Offer;
...
public class SendOfferActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                rateRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        sendMessage(getUid(),postuid,"Hello, I am claiming your posted food: "+ postTitle + ". Please check your Post page");
                    }
                    @Override
    ...
    private void submitOffer() {
        final String name = offerTitle.getText().toString();
                ...
                new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (user == null) {
                            ...
                            Offer offer = new Offer(userId,author,name,description,address,picture,offerPostKey,status);
